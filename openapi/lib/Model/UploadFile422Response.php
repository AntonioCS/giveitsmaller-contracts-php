...
/**
 * UploadFile422Response Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class UploadFile422Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'uploadFile_422_response';
    ...
    public const ERROR_TYPE_UPLOAD_DURATION_EXCEEDS_TIER = 'upload_duration_exceeds_tier';
    ...
    {
        return [
            self::ERROR_TYPE_UPLOAD_DURATION_EXCEEDS_TIER,
        ];
    }
     ...
     * Sets max_size_bytes
     *
     * @param int $max_size_bytes Max size permitted at the caller's current tier + MIME.
     *
     * @return self
     */
     ...
     *
     * @param int $max_duration_seconds Max duration permitted at the caller's current tier + MIME.
     *
     * @return self
     */
    public function setMaxDurationSeconds($max_duration_seconds)
    {
        if (is_null($max_duration_seconds)) {
            throw new \InvalidArgumentException('non-nullable max_duration_seconds cannot be null');
        }

        if (($max_duration_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_duration_seconds when calling UploadFile422Response., must be bigger than or equal to 0.');
        }
