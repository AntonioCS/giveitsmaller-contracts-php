...
/**
 * SseMultiOutputCompletionWithKind Class Doc Comment
 *
 * @category Class
 * @description Multi-output branch of &#x60;SseOperationCompletionResult&#x60; — wraps &#x60;SseMultiOutputCompletion&#x60; + the shared &#x60;SseCompletionBase&#x60; + pins &#x60;result_kind&#x60; to the literal &#x60;\&quot;multi\&quot;&#x60;. See &#x60;SseOperationCompletionResult&#x60; description for the rationale + codegen-quirk context.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SseMultiOutputCompletionWithKind implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SseMultiOutputCompletionWithKind';
    ...
    public function setOutputs($outputs)
    {
        ...
        if ((count($outputs) > 200)) {
            throw new \InvalidArgumentException('invalid value for $outputs when calling SseMultiOutputCompletionWithKind., number of items must be less than or equal to 200.');
        }
        if ((count($outputs) < 1)) {
            throw new \InvalidArgumentException('invalid length for $outputs when calling SseMultiOutputCompletionWithKind., number of items must be greater than or equal to 1.');
        }
    ...
    public function setTotalOutputSizeBytes($total_output_size_bytes)
    {
        ...
        if (($total_output_size_bytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_output_size_bytes when calling SseMultiOutputCompletionWithKind., must be bigger than or equal to 0.');
        }
