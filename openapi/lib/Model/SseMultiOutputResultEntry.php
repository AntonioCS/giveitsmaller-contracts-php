...
class SseMultiOutputResultEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets page_index
     *
     * @param int|null $page_index 1-based page number for PDF-page fan-out outputs (convert PDF->image). Gapless within an operation (an N-page conversion emits `page_index` 1..N). Mutually exclusive with `position`. Absent on non-indexed outputs. Mirrors `OperationResultOutputEntry.page_index`. Per ADR-0009 §D2.
     *
     * @return self
     */
