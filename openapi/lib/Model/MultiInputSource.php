...
/**
 * MultiInputSource Class Doc Comment
 *
 * @category Class
 * @description Discriminated union of source leaves consumed by &#x60;JobInputV2.source&#x60; (multi-input operation inputs). A 3-leaf subset of &#x60;WorkflowSource&#x60; that **excludes the &#x60;upload&#x60; leaf** — uploads cannot be referenced directly inside a multi-input &#x60;inputs[]&#x60; array. An uploaded file that must feed a multi-input operation enters via a &#x60;passthrough&#x60; source job (a single-input job with &#x60;operations: [{type: passthrough}]&#x60;) and is referenced here as &#x60;{ type: job_output, from: &lt;id&gt; }&#x60;, which preserves billing / DAG / lineage. Structured like the &#x60;ExternalSource&#x60; subset alias but retaining &#x60;job_output&#x60; (the passthrough bridge). Per ticket [&#x60;4som89Uh&#x60;](https://trello.com/c/4som89Uh) + ADR-0004 / ADR-0005.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MultiInputSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MultiInputSource';
    ...
    public function setExternalSourceId($external_source_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($external_source_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_source_id when calling MultiInputSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setConnectionId($connection_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($connection_id)))) {
            throw new \InvalidArgumentException("invalid value for \$connection_id when calling MultiInputSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
