 ...
 *
 * @category Class
 * @description Single input reference for multi-input operations. Each references a specific job and optionally a specific operation output from that job.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class JobInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ref
     *
     * @param string $ref Reference label of the upstream job
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string|null $operation Specific operation output to use. If omitted, uses the last operation's output.
     *
     * @return self
     */
     ...
     *
     * @param array<string,mixed>|null $per_input_options Per-input option overrides. For merge operations, individual inputs can override global transition settings for the join point preceding this input. Keys are option names, values are the override values.
     *
     * @return self
     */
