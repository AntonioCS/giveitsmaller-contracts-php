...
/**
 * MultipartKeepaliveResponse Class Doc Comment
 *
 * @category Class
 * @description Refreshed manifest TTL for an in-flight multipart session. The &#x60;data&#x60; payload on &#x60;POST /api/uploads/multipart/{uploadId}/keepalive&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MultipartKeepaliveResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MultipartKeepaliveResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['manifest_expires_at'] === null) {
    ...
    public function setUploadId($upload_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($upload_id)))) {
            throw new \InvalidArgumentException("invalid value for \$upload_id when calling MultipartKeepaliveResponse., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
     ...
     *
     * @param \DateTime $manifest_expires_at ISO-8601 expiry timestamp of the refreshed manifest. Always non-null on a successful 200 response — keepalive unconditionally extends the TTL to 48 h ahead of `now`.
     *
     * @return self
     */
    public function setManifestExpiresAt($manifest_expires_at)
    {
        if (is_null($manifest_expires_at)) {
            throw new \InvalidArgumentException('non-nullable manifest_expires_at cannot be null');
        }
