...
class SseOperationFailedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets error_code
     *
     * @param string $error_code Machine-readable operation failure code (failed only). Same closed vocabulary as `OperationResponse.error_code` / the AsyncAPI `ErrorCode` enum (the source of truth) — see `OperationResponse.error_code` for the full code set + meanings + retry semantics. Consumers MUST degrade an unknown value to a generic reason.
     *
     * @return self
     */
