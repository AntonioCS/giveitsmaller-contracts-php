...
/**
 * ConnectionSource Class Doc Comment
 *
 * @category Class
 * @description Reference to a vaulted connection (pre-registered via &#x60;POST /api/connections&#x60; — owned by cross-repo &#x60;compression_api&#x60; work item X10 per ADR-0005; vault endpoint not yet filed as a Trello ticket). For recurring access to the customer&#39;s S3 / GCS / Azure / Dropbox / Google Drive / OneDrive. Credentials NEVER appear on the wire; only the &#x60;connection_id&#x60; handle does.  Per [ADR-0005](../docs/decisions/0005-external-sources.md) §\&quot;ConnectionSource\&quot;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConnectionSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConnectionSource';
    ...
    public function setConnectionId($connection_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($connection_id)))) {
            throw new \InvalidArgumentException("invalid value for \$connection_id when calling ConnectionSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
