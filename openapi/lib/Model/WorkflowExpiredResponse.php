...
/**
 * WorkflowExpiredResponse Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class WorkflowExpiredResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WorkflowExpiredResponse';
    ...
    {
        return [
            self::ERROR_TYPE_WORKFLOW_EXPIRED,
        ];
    }
     ...
     * Sets error_type
     *
     * @param string $error_type Discriminator value for this 422 envelope.
     *
     * @return self
     */
     ...
     * Sets expired_at
     *
     * @param \DateTime $expired_at ISO-8601 timestamp the workflow transitioned to `expired`. Default TTL is 7 days from `paused_at`; server-side configurable per ADR-0001 §1.7 row 6.
     *
     * @return self
     */
