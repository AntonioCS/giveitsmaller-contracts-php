...
class UploadResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets file_id
     *
     * @param string $file_id Unique file identifier for use in workflow creation
     *
     * @return self
     */
     ...
     *
     * @param \Gisl\Generated\OpenApi\Model\UploadConstraintsApplied $constraints_applied Tier+MIME-derived constraints the server applied to this upload per ticket [I15-CONS](https://trello.com/c/YZpBKzOM) F8.1. REQUIRED on every successful upload (V2 cutover invariant); lets the frontend display tier-specific size + duration caps and the server's pre-assignment of `processing_class` (used for early UI gating before workflow-create).
     *
     * @return self
     */
