...
/**
 * CodegenSourceInput Class Doc Comment
 *
 * @category Class
 * @description One multi-input entry — the allowlisted mirror of &#x60;JobInputV2&#x60;: a reproducible &#x60;MultiInputSource&#x60; (&#x60;job_output&#x60; / &#x60;external_import&#x60; / &#x60;connection&#x60; — the canonical request leaves, which round-trip &#x60;from&#x60;+&#x60;operation&#x60; / external handle / &#x60;connection_id&#x60;+&#x60;path&#x60; verbatim) plus the input &#x60;role&#x60; and authored &#x60;per_input_options&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CodegenSourceInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CodegenSourceInput';
     ...
     * Sets role
     *
     * @param string|null $role Input role for role-based multi-input ops (omitted where the op has a single implicit role). Mirrors the `JobInputRole` request vocabulary; keep in sync if that enum widens.
     *
     * @return self
     */
     ...
     *
     * @param array<string,mixed>|null $per_input_options Per-input options for this input, as authored — public keys only (internal/defaulted keys excluded).
     *
     * @return self
     */
