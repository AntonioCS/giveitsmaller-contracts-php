...
/**
 * UploadFile403Response Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class UploadFile403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'uploadFile_403_response';
    ...
    public function setViolations($violations)
    {
        ...
        if ((count($violations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $violations when calling UploadFile403Response., number of items must be greater than or equal to 1.');
        }
