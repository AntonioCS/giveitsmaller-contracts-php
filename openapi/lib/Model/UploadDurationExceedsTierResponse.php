...
/**
 * UploadDurationExceedsTierResponse Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class UploadDurationExceedsTierResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UploadDurationExceedsTierResponse';
    ...
    public function setMaxDurationSeconds($max_duration_seconds)
    {
        ...
        if (($max_duration_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_duration_seconds when calling UploadDurationExceedsTierResponse., must be bigger than or equal to 0.');
        }
