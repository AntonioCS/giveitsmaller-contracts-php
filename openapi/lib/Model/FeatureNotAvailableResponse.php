 ...
 *
 * @category Class
 * @description 422 response body when a workflow references one or more features whose availability is not &#x60;stable&#x60; (i.e. &#x60;planned&#x60;, &#x60;experimental&#x60;, or &#x60;beta&#x60; not enabled for this caller).  Per ADR-0001 §1.3 Tension 1 rule, the server MUST honour tagged availability and MUST NOT silently reject spec-valid features with a generic schema error. This envelope is the structured rejection.  The 422 response is delivered alongside &#x60;ValidationErrorEnvelope&#x60;, &#x60;ProcessingClassExceedsBandResponse&#x60;, and &#x60;ProbePendingResponse&#x60; via a &#x60;oneOf&#x60; with an explicit &#x60;error_type&#x60; discriminator (per [ADR-0018](../docs/decisions/0018-universal-422-error-type-discriminator.md)); this branch&#39;s discriminator value is &#x60;feature_not_available&#x60;. See the 422 response on &#x60;POST /api/workflows&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
