...
/**
 * FeatureNotAvailableResponse Class Doc Comment
 *
 * @category Class
 * @description 422 response body when a workflow references one or more features whose availability is not &#x60;stable&#x60; (i.e. &#x60;planned&#x60;, &#x60;experimental&#x60;, or &#x60;beta&#x60; not enabled for this caller).  Per ADR-0001 §1.3 Tension 1 rule, the server MUST honour tagged availability and MUST NOT silently reject spec-valid features with a generic schema error. This envelope is the structured rejection.  The 422 response is delivered alongside &#x60;ValidationErrorEnvelope&#x60; and &#x60;ProcessingClassExceedsBandResponse&#x60; via a naked &#x60;oneOf&#x60; (duck-typed on required-field shape — &#x60;details&#x60; vs &#x60;error_type&#x60; value: &#x60;feature_not_available&#x60; vs &#x60;processing_class_exceeds_band&#x60;). No discriminator object is used because &#x60;ValidationErrorEnvelope&#x60; has no &#x60;error_type&#x60; field. See the 422 response on &#x60;POST /api/workflows&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FeatureNotAvailableResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FeatureNotAvailableResponse';
    ...
    public function setViolations($violations)
    {
        ...
        if ((count($violations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $violations when calling FeatureNotAvailableResponse., number of items must be greater than or equal to 1.');
        }
