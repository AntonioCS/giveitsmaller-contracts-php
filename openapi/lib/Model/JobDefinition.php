...
class JobDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets operations
     *
     * @param \Gisl\Generated\OpenApi\Model\OperationDefinition[]|null $operations Ordered list of operations. Executed sequentially — each operation consumes the previous operation's output; all intermediate and final outputs are kept.  Multi-input jobs (with `inputs[]`) must have exactly one operation, and it must be a multi-input type (`merge`, `archive`, `image_watermark`, `custom_luma`, `audio_overlay`, or `audio_to_video`).
     *
     * @return self
     */
