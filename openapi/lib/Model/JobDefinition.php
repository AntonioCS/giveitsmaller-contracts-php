...
class JobDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets inputs
     *
     * @param \Gisl\Generated\OpenApi\Model\JobInputV2[]|null $inputs Multi-input list for `merge`, `archive`, `image_watermark`, `custom_luma`, and `audio_overlay`. Each entry is a `JobInputV2` with its own `WorkflowSource`. Mutually exclusive with `source`.
     *
     * @return self
     */
