 ...
 *
 * @category Class
 * @description Cursor-paginated page of workflow summaries (most-recent-first). Walk pages by passing &#x60;next_cursor&#x60; as the next request&#39;s &#x60;cursor&#x60; query parameter until &#x60;is_truncated: false&#x60;. Cursor pagination (opaque &#x60;(created_at, id)&#x60; token) mirrors the multipart-parts listing convention — NOT the offset-based &#x60;/api/v2/credits/usage&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class WorkflowListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'workflows' => '\Gisl\Generated\OpenApi\Model\WorkflowSummary[]',
        'next_cursor' => 'string',
        'is_truncated' => 'bool'
    ];
     ...
     * Gets workflows
     *
     * @return \Gisl\Generated\OpenApi\Model\WorkflowSummary[]
     */
     ...
     * Sets workflows
     *
     * @param \Gisl\Generated\OpenApi\Model\WorkflowSummary[] $workflows This page of workflow summary rows (most-recent-first).
     *
     * @return self
     */
     ...
     * Sets is_truncated
     *
     * @param bool $is_truncated `true` when more pages remain; `false` on the final page.
     *
     * @return self
     */
