 ...
 *
 * @category Class
 * @description Whether the operation accepts a single file or multiple files: - single: One input file (compress, thumbnail, thumbnail_image,   thumbnail_video, thumbnail_document, thumbnail_office,   text_watermark, convert, audio_watermark) - multi: Multiple input files (merge, archive, image_watermark, custom_luma, audio_overlay)
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
