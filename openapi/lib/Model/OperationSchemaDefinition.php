...
class OperationSchemaDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['min_inputs']) && ($this->container['min_inputs'] < 2)) {
            $invalidProperties[] = "invalid value for 'min_inputs', must be bigger than or equal to 2.";
        }
     ...
     * Sets min_inputs
     *
     * @param int|null $min_inputs Minimum number of inputs (multi-input operations only)
     *
     * @return self
     */
    public function setMinInputs($min_inputs)
    {
        ...
        if (($min_inputs < 2)) {
            throw new \InvalidArgumentException('invalid value for $min_inputs when calling OperationSchemaDefinition., must be bigger than or equal to 2.');
        }
     ...
     * Sets options
     *
     * @param array<string,\Gisl\Generated\OpenApi\Model\OptionSchema> $options Global options applicable regardless of MIME type, keyed by option name. For operations with mime_groups, these are the common options.
     *
     * @return self
     */
