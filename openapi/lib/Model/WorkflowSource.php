...
/**
 * WorkflowSource Class Doc Comment
 *
 * @category Class
 * @description Discriminated union of source leaves (all 4, including &#x60;upload&#x60;) consumed by V2 single-input &#x60;JobDefinition.source&#x60;. Multi-input &#x60;JobInputV2.source&#x60; consumes the narrower &#x60;MultiInputSource&#x60; (this union minus the &#x60;upload&#x60; leaf) — see that schema and &#x60;JobInputV2&#x60;. Per [ADR-0005](../docs/decisions/0005-external-sources.md) + [ADR-0004](../docs/decisions/0004-job-shape.md).  Wiring into &#x60;JobDefinition&#x60; lands via ticket [I12 (&#x60;Gr0VKFya&#x60;)](https://trello.com/c/Gr0VKFya).
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WorkflowSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WorkflowSource';
    ...
    public function setFileId($file_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($file_id)))) {
            throw new \InvalidArgumentException("invalid value for \$file_id when calling WorkflowSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setExternalSourceId($external_source_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($external_source_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_source_id when calling WorkflowSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setConnectionId($connection_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($connection_id)))) {
            throw new \InvalidArgumentException("invalid value for \$connection_id when calling WorkflowSource., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
