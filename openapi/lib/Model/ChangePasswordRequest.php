...
class ChangePasswordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'changePassword_request';
    ...
    public function setCurrentPassword($current_password)
    {
        ...
        if ((mb_strlen($current_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $current_password when calling ChangePasswordRequest., must be bigger than or equal to 1.');
        }
