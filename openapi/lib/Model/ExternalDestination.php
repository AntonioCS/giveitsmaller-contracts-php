...
/**
 * ExternalDestination Class Doc Comment
 *
 * @category Class
 * @description Write-side counterpart to &#x60;ExternalSource&#x60;. Used when a workflow&#39;s &#x60;delivery_plan&#x60; writes outputs to a customer-controlled destination (S3 bucket, GCS bucket, Dropbox folder, etc.). Per ADR-0005, write auth semantics differ from read auth (validation + scoping is write-permission-based, not SSRF-based) — the schema family mirrors &#x60;ExternalSource&#x60; shape; auth/policy differences live in runtime.  Replaces V1 &#x60;ExportConfig&#x60; schema (deleted at V2 cutover via ticket I12).  Future extension may add write-policy fields (&#x60;write_mode&#x60;, &#x60;overwrite_policy&#x60;, etc.) — tracked as a follow-up ticket.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExternalDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExternalDestination';
    ...
    public function setExternalSourceId($external_source_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($external_source_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_source_id when calling ExternalDestination., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
    ...
    public function setConnectionId($connection_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($connection_id)))) {
            throw new \InvalidArgumentException("invalid value for \$connection_id when calling ExternalDestination., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
