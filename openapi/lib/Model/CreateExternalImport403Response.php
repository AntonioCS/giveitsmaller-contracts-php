<?php
/**
 * CreateExternalImport403Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateExternalImport403Response Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateExternalImport403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createExternalImport_403_response';
    ...
    public const ERROR_TYPE_FEATURE_TIER_RESTRICTED = 'feature_tier_restricted';
    ...
    {
        return [
            self::ERROR_TYPE_FEATURE_TIER_RESTRICTED,
        ];
    }
     ...
     * Sets error_type
     *
     * @param string $error_type Discriminator for the 403 oneOf. Always `feature_tier_restricted`.
     *
     * @return self
     */
     ...
     * Sets violations
     *
     * @param \Gisl\Generated\OpenApi\Model\FeatureViolation[] $violations One entry per tier-gated feature. Each `FeatureViolation` MUST set `required_tier` to the tier that would satisfy the request.
     *
     * @return self
     */
    public function setViolations($violations)
    {
        ...
        if ((count($violations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $violations when calling CreateExternalImport403Response., number of items must be greater than or equal to 1.');
        }
