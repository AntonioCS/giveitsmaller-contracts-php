...
/**
 * SseJobFailedData Class Doc Comment
 *
 * @category Class
 ...
 */
class SseJobFailedData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SseJobFailedData';
    ...
    public function setJobId($job_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($job_id)))) {
            throw new \InvalidArgumentException("invalid value for \$job_id when calling SseJobFailedData., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
