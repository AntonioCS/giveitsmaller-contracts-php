...
/**
 * FeatureTierRestrictedResponse Class Doc Comment
 *
 * @category Class
 * @description 403 response body when a workflow references one or more features gated by a higher subscription tier than the caller has.  Distinct from &#x60;TierRestrictionResponse&#x60; (also 403): this envelope is per-feature granularity (operation / mime_group / option / per_value); &#x60;TierRestrictionResponse&#x60; is request-level (file size or MIME). The two envelopes are discriminated by &#x60;error_type&#x60; at the response &#x60;oneOf&#x60; level.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FeatureTierRestrictedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FeatureTierRestrictedResponse';
    ...
    public function setViolations($violations)
    {
        ...
        if ((count($violations) < 1)) {
            throw new \InvalidArgumentException('invalid length for $violations when calling FeatureTierRestrictedResponse., number of items must be greater than or equal to 1.');
        }
