...
/**
 * ExternalImportToken Class Doc Comment
 *
 * @category Class
 * @description Opaque handle returned by &#x60;POST /api/external-imports&#x60; for a one-shot bearer URL (S3 presigned, GCS signed, Azure SAS, Dropbox shared link, public HTTPS). The original URL + password are encrypted server-side and never returned in any subsequent response. Per [ADR-0005](../docs/decisions/0005-external-sources.md) §\&quot;ExternalImportToken\&quot;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ExternalImportToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ExternalImportToken';
    ...
    public function setExternalSourceId($external_source_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/", ObjectSerializer::toString($external_source_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_source_id when calling ExternalImportToken., must conform to the pattern /^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.");
        }
