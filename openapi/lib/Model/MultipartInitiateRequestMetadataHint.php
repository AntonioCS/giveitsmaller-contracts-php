 ...
 *
 * @category Class
 * @description Optional caller-asserted preflight metadata for routing- quality preview per ticket [I15-CONS](https://trello.com/c/YZpBKzOM) F8.1. **Advisory only** — server probes the first chunk regardless and rejects on actual measurement; the hint cannot be used to bypass tier caps. Used to populate &#x60;MultipartInitiateResponse.constraints_applied.processing_class_pre_assignment&#x60; when the first-chunk probe alone is insufficient (e.g. container metadata not present in the first 8 MB). Single uploads (&#x60;POST /api/uploads&#x60;) do NOT accept this hint — the server has the full byte stream.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
