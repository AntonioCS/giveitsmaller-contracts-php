...
/**
 * ErrorEnvelope Class Doc Comment
 *
 * @category Class
 * @description Base error response envelope. All error responses (4xx / 5xx) extend or use this shape. Per ticket [I26](https://trello.com/c/rcnqwgI4) every error carrier supports the optional localisation triple (&#x60;message_key&#x60; + &#x60;locale&#x60; + &#x60;message_params&#x60;) plus the existing machine-readable &#x60;error&#x60; code.  **SDK consumer guidance.** Switch on &#x60;error&#x60; (canonical machine code, never localised) for typed error-branch helpers. Surface &#x60;message_key&#x60; (canonical lookup vocab, never localised) to your SDK&#39;s translation layer. Display &#x60;message&#x60; (localised per the &#x60;Accept-Language&#x60; request header). **Never parse &#x60;message&#x60; for control flow** — it changes per locale.  See the API-level \&quot;Localisation\&quot; section in &#x60;info.description&#x60; for the request/response header contract (&#x60;Accept-Language&#x60; ↔ &#x60;Content-Language&#x60; + &#x60;Vary: Accept-Language&#x60;) and the fallback locale (&#x60;en-GB&#x60;).
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ErrorEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ErrorEnvelope';
