...
/**
 * UploadSizeExceedsTierResponse Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class UploadSizeExceedsTierResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UploadSizeExceedsTierResponse';
    ...
    public const ERROR_TYPE_UPLOAD_SIZE_EXCEEDS_TIER = 'upload_size_exceeds_tier';
    ...
    {
        return [
            self::ERROR_TYPE_UPLOAD_SIZE_EXCEEDS_TIER,
        ];
    }
