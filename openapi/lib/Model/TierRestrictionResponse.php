...
/**
 * TierRestrictionResponse Class Doc Comment
 *
 * @category Class
 * @description 403 response body for request-level tier-quota violations on upload + workflow-create endpoints (file size or MIME).  Distinct from &#x60;FeatureTierRestrictedResponse&#x60; (also 403): this envelope is request-scoped (one restriction per request, e.g. the file is too big); &#x60;FeatureTierRestrictedResponse&#x60; is per-feature granularity inside a workflow body (e.g. a workflow references multiple operations / options that require a higher tier).  The two envelopes share status 403 and are discriminated by &#x60;error_type&#x60; at the response-schema &#x60;oneOf&#x60; level — see the &#x60;oneOf + discriminator&#x60; block on each path&#39;s 403 response.  Mirrors the runtime shape produced by &#x60;compression_api&#x60;&#39;s &#x60;FileUploadController::tierRestrictionExtras&#x60; + &#x60;WorkflowsController&#x60; after PR #179 (API ticket HPfGvPTZ).
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TierRestrictionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TierRestrictionResponse';
    ...
    protected static $openAPITypes = [
        ...
        'error_type' => 'string',
        'restriction_kind' => '\Gisl\Generated\OpenApi\Model\TierRestrictionKind',
    ...
    protected static $setters = [
        ...
        'restriction_kind' => 'setRestrictionKind',
    ...
    protected static $getters = [
        ...
        'restriction_kind' => 'getRestrictionKind',
    ...
    public const ERROR_TYPE_TIER_RESTRICTION = 'tier_restriction';
    ...
    {
        return [
            self::ERROR_TYPE_TIER_RESTRICTION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('restriction_kind', $data ?? [], null);
        $this->setIfExists('current_tier', $data ?? [], null);
     ...
     * Sets error_type
     *
     * @param string $error_type Discriminator for the 403 oneOf. Always `tier_restriction` for this envelope.
     *
     * @return self
     */
    ...
    /**
     * Gets restriction_kind
     *
     * @return \Gisl\Generated\OpenApi\Model\TierRestrictionKind
     */
    public function getRestrictionKind()
    {
        return $this->container['restriction_kind'];
    }

    /**
     * Sets restriction_kind
     *
     * @param \Gisl\Generated\OpenApi\Model\TierRestrictionKind $restriction_kind restriction_kind
     *
     * @return self
     */
    public function setRestrictionKind($restriction_kind)
    {
        if (is_null($restriction_kind)) {
            throw new \InvalidArgumentException('non-nullable restriction_kind cannot be null');
        }
        $this->container['restriction_kind'] = $restriction_kind;
    ...
    {
        return $this->container['current_tier'];
    }

    /**
     * Sets current_tier
     *
     * @param \Gisl\Generated\OpenApi\Model\UserTier $current_tier current_tier
     *
     * @return self
     */
    public function setCurrentTier($current_tier)
    {
        if (is_null($current_tier)) {
            throw new \InvalidArgumentException('non-nullable current_tier cannot be null');
        }
        $this->container['current_tier'] = $current_tier;
