...
/**
 * JobSource Class Doc Comment
 *
 * @category Class
 * @description Reference to another job&#39;s output for single-input downstream jobs. The input is the referenced job&#39;s output, resolved via the incoming workflow edge.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class JobSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobSource';
    ...
    */
     ...
     * Sets operation
     *
     * @param string|null $operation Specific operation output to use from the upstream job. If omitted, uses the last operation's output.
     *
     * @return self
     */
