...
/**
 * CodegenUploadPlaceholder Class Doc Comment
 *
 * @category Class
 * @description Stand-in for a user UPLOAD source in a replay projection — descriptive metadata so a consumer can re-prompt for an equivalent file. NOT the bytes or storage key (the original upload is consumed/expired), so it is deliberately NOT a re-submittable &#x60;UploadSource&#x60;.
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CodegenUploadPlaceholder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CodegenUploadPlaceholder';
    ...
    public function setFilename($filename)
    {
        ...
        if ((mb_strlen($filename) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling CodegenUploadPlaceholder., must be smaller than or equal to 1024.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling CodegenUploadPlaceholder., must be smaller than or equal to 100.');
        }
    ...
    public function setSizeBytes($size_bytes)
    {
        ...
        if (($size_bytes < 0)) {
            throw new \InvalidArgumentException('invalid value for $size_bytes when calling CodegenUploadPlaceholder., must be bigger than or equal to 0.');
        }
