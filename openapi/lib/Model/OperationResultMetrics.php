...
class OperationResultMetrics implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets chosen_quality
     *
     * @param int|null $chosen_quality The quality the encode-measure loop settled on for a `target_size` encode (`encoding_mode: target_size`). Present only for a target_size operation. Mirrors the AsyncAPI `OperationMetrics.chosen_quality`; lets the client show \"hit your target at quality 66\".
     *
     * @return self
     */
