...
/**
 * CapabilityConditionOneOf3 Class Doc Comment
 *
 * @category Class
 * @package  Gisl\Generated\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class CapabilityConditionOneOf3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CapabilityCondition_oneOf_3';
     ...
     * Sets field
     *
     * @param string $field Field token under test (e.g. `output_format`, `compress.encoding_mode`).
     *
     * @return self
     */
